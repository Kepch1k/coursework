...
function Navigation(props) {
    ...
    function resize() {
        ...
        const newNavigationWidth = (props.Nav.show)?(navigationWidth-305):navigationWidth+335;
    ...
    /*(
        ...
        <nav className={`${style.navigation}`} id={"navigation"}>
            ...
            <div className={`${style.forLocation}`} style={{width:(props.Nav.show)?"300px":"0",marginLeft:(props.Nav.show)?"20px":"0"}}>
